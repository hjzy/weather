...
public class Weather {//Java EE写多了
    ...
    private int error;//error代码
    private String status;//数据获取状态
    private String date;//日期
    private List<ResultsBean> results;//返回的json
    ...
    public static class ResultsBean {
        ...
        private List<IndexBean> index;//天气建议
        private List<WeatherDataBean> weather_data;//天气数据
        ...
        public static class IndexBean {
            ...
            private String title;//指数标题
            private String zs;//指数
        ...
        public static class WeatherDataBean {
            ...
            private String date;//日期
            private String dayPictureUrl;//白天天气图标的url，从百度接口获取天气图标
